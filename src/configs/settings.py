...
SCENE_RULE_FILE = _env_first(
    ...
    os.path.join(PROJECT_ROOT, "src", "configs", "domain", "scene_permission_rules_16.json"),
)
...
# LLM / Agent
# =========================
AGENT_BASE_URL = _env_first(["LLMMUI_AGENT_BASE_URL", "AGENT_BASE_URL"], "http://127.0.0.1:8011/v1")
AGENT_MODEL = _env_first(
    ["LLMMUI_AGENT_MODEL", "AGENT_MODEL"],
