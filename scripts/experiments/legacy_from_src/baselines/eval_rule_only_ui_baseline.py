...
# -*- coding: utf-8 -*-
"""
Evaluate rule-only UI baseline predictions against label_judge.json.
"""
...
DEFAULT_PRED_FILE = "result_rule_only_keyword.json"
DEFAULT_GT_FILE = "label_judge.json"
DEFAULT_OUT_FILE = "rule_only_ui_baseline_eval.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate rule-only binary baseline")
    ...
    print("========== Rule-Only UI Baseline Evaluation ==========")
